...
endpoint is configured, use the [support page](docs/SUPPORT.md) and its private
security-advisory link with a minimal reproduction. Do not include credentials
or private automation definitions.
